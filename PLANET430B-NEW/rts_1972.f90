 program planets
!--- Compilation command: gfortran -w rts_1972.f90 sky77.for 1919.for jpl_430A.f -o rts_1972.exe
...
!  Ratio between solar and sidereal time
      ...
      INTEGER FINAL_,JW,EQTM,IY1, IM1, ID1,IDMSF6(4),d_d,h_h,m_m,conta,Dtoday,Mtoday,Ytoday,MJDtoday
      INTEGER IYF, MOF, IDF,N0,MS,PT,NUM,JJ,IHMSF6(4)
      ...
      DOUBLE PRECISION RA3,DE3,RA4,DE4,RA5,DE5,RA6,DE6,RA7,DE7,RA8,DE8,RA9,DE9,ddec,DJM0,RA10,DE10,ut1_notid
      DOUBLE PRECISION RMASSE,SUNLONG,COSELON,EDEC,EVET,GLON,GLAT,XEL,DIST,DIST4,ECC,dra,JDtoday,TDBA,TDBB         
      DOUBLE PRECISION DPSI, DEPS, EPSA, ERA, DP00, DE00, DDP00, DDE00 ,ELON, DELTAT, EARTHVEC,RA_3,JTRS2 
      ...
      DOUBLE PRECISION latit,UJD,MJD,ANGLE,PANGLE,PDIAM,AZ,height,ZD,MAGN,AUM,Dtime,IMJD,PVV(2),DJMF
      DOUBLE PRECISION RA7H, DE7D,JD,RVET,RVET0,EPOS,EPSA0,RB0,RP0,RPB0,RN0,DP000,DE000,DPSI0,DEPS0,MM
      DOUBLE PRECISION DIST5,DX0,DY0,UT_0,TT_0,GAST0,PL,SD,RIS,SET,TRS,AZM1,AZM2,HAL,MUC,BP,de_S,TIME1
      DOUBLE PRECISION C,MU,u2,RAR,DER,K,TAU,THD,TGD,ILL,COSI,DET,HD,GD,HMOD,DIST1,DIST2,DIST3,cosDE,sinRA
      DOUBLE PRECISION RC2IT(3,3),RC2I(3,3),RPB(3,3),RNPB0(3,3),RN(3,3),RNPB(3,3), RP(3,3),RBP(3,3),iau_OBL80
      ...
      DOUBLE PRECISION DE_GMST,EQTMG,UTC0,UTC01,UTC02,RA06,EQTX,BODY_sun(3),R_sun,JHE,MJ,tanAX,AX,JTT 
      ...
      DOUBLE PRECISION  R(6),B(8,3),OBL6,uu(3),SAB(3,2),JUB(3,2)
      ...
      !  *                                                                        *
      !  *     Compiling command:                                                 *
      !  *     gfortran -w rts.f90 sky77.for 1919.for jpl_430A.f                      *
...
!!-----------------------------   OUTPUT  ----------------------------------------
      ...
      WRITE (*,42)IY, MO, ID, IHMSF1,AS1,IHMSF3,AS3,IHMSF2,AS2,azm1,HAL,azm2,IHMSF6,sign2,IDMSF6,IHMSF0,AS3,sign1,IDMSF0,AS3 
                     

42    FORMAT ( x,I4,"/",I2,"/",I2,2x,I3,2(":",I2.2),".",I1.1,a2,2x,I3,2(":",I2.2),".",I1.1,a2,2X,I3,2(":",I2.2),".",I1.1,a2  &
          ,2X,F6.2,"°",3X,F5.2,"°",3X,F6.2,"°",2x,I3,2(":",I2.2),".",I1.1,3x,a,I3,2(":",I2.2),".",I1.1,3x,I3,2(":",I2.2),"." &
          ,I1.1,a,2x,a,I3,2(":",I2.2),".",I1.1,a )
