...
!  Ratio between solar and sidereal time
      ...
      INTEGER IHMSF1(4),IHMSF2(4),IHMSF3(4),IHMSF(4),IDMSF(4), IDMSF0(4),IHMSF4(4),IHMSF5(4),Rtoday,YN
      INTEGER FINAL_,JW,EQTM,IY1, IM1, ID1,IDMSF1(4),d_d,h_h,m_m,conta,Dtoday,Mtoday,Ytoday,MJDtoday
      ...
      DOUBLE PRECISION latit,UJD,MJD,ANGLE,PANGLE,PDIAM,AZ,height,ZD,MAGN,AUM,Dtime,IMJD,PVV(2)
      ...
      WRITE (*,*)"  *         prior the last full row, idem for database EOP14 C04           *" 
      WRITE (*,*)"  *                                                                        *"
      WRITE (*,*)"  **************************************************************************"
      WRITE (*,*)
...
!      FINAL_ = MJDtoday + 300                     ! reported in MJD IERS FINAL_ A database (for update) 
                                                 ! FINAL_ is 300 days ahead advances 1 day a day
...
!----------Call the interpolation routine for per XP,YP,DUT,dX,dY
      ...
      CALL iers_calc(UTC,DATE_,FINAL_,EOP_final,XPO,YPO,DUT,LOD,DX0,DY0)
...
!      WRITE (*,*) " NUTATION 80 ",NUT(1),NUT(2),NUT(3),NUT(4)      
      WRITE (*,*)
      WRITE (*,*)"=================================================================="
      WRITE (*,*)
