  Program LAMBT;
        { PROBLEMA di LAMBERT risolto con le VARIABILI UNIVERSALI (Metodo BATE)
          Determinazione degli elementi ORBITALI di una CONICA, NOTI:
               ...
               2 - L'angolo di trasferimento Theta
               3 - Il tempo di Percorrenza tau=t2-t1
  ‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹‹
  ...
  Procedure LogoDatiLAMBERT;
   Begin
     ...
     gotoxy(7,3); writeln('---------------------------------------------------------------------');
     textcolor(14);
     gotoxy(25,5); write(' Raggio Vettore r1     [DU] = '); read(r1);
     gotoxy(25,6); write(' Raggio Vettore r2     [DU] = '); read(r2);
...
textcolor (10);
     ...
     z:=1;  { Valore iniziale di z=x^2/a = Parametro adimensionale }
repeat
                   ...
                   end;
{
 ...
 writeln('          M=',anoM/rad:7:4,'¯');
     ...
     gotoxy(32,13);write('================');
     writeln;
     writeln('                     Semiasse magg.  a = ',a:11:8,' DU');
     writeln('                     Eccentricita''   e = ',e:11:8);
if e <= 0.9995 then writeln('                     Periodo Rivol.  P = ',Triv:11:6,' sec');
     writeln('                     Param.focale    p = ',p:11:8,' DU');
     writeln('                     Dist.perielia   q = ',q:11:8,' DU');
     writeln('                     VelocitÖ_1     V1 = ',V1:11:8,' DU/TU = ',V1*uv0:6:5,' km/s');
     writeln('                     VelocitÖ_2     V2 = ',V2:11:8,' DU/TU = ',V2*uv0:6:5,' km/s');
     writeln('                     Anomalia_P1    Ì1 = ',fi1/rad:11:6,'¯');
     writeln('                     Pass.Perie. t1-Tp = ',t1menoTp/kgauss:7:1,' sec');
     textcolor(1);
