Program P_GAUS;       { Determinazione dei Parametri Orbitali di un Corpo Celeste
                        ...
                        1-6-2002 riga 380: aggiunta normalizzazione
                        Tp=passag. al perielio orbite ellittiche }
  Uses  Graph,Crt;
  ...
  Procedure SLICE;
   Var
    ...
    Begin
     gotoxy(22,4); write('Nome del File-Dati (senza ext.)= ');
     read (w);
     textcolor(10);
  ...
  Procedure ELLISSE;
   Var
    ...
    Begin
     ...
     M2:=E2-e*SinE2;
     Tper:=-M2/motoang;
   {...... aggiunta questa normalizzazione del Tp}
       if Tper< -0.5/motoang then Tper:=Tper+Triv*2*pi/kgauss;
       if Tper>  0.5/motoang then Tper:=Tper-Triv*2*pi/kgauss;
